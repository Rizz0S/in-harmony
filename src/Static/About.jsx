...
const About = () => {
  return (
    <div className="about">
      ...
      <p>I made this website with JavaScript, React, and Redux. I'm also utilizing the Javascript packages <a href=" https://iro.js.org/" target="blank">iro.js</a>, <a href="https://www.npmjs.com/package/get-pixels" target="blank">get-pixels</a>, <a href="https://www.npmjs.com/package/chroma-jschroma.js" target="blank">chroma.js</a>, <a href="https://www.npmjs.com/package/react-card-flip" target="blank">react-card-flip</a>, and <a href="https://www.npmjs.com/package/react-alert" target="blank">react-alert</a>. The back-end is built with Rails, postgresql, and complete with JWT Auth and B-Crypt password protection.
      <br/>
